...
class MyClass(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        this = _example_swig.new_MyClass()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _example_swig.delete_MyClass
    __del__ = lambda self : None;
    def greet(self, *args): return _example_swig.MyClass_greet(self, *args)
MyClass_swigregister = _example_swig.MyClass_swigregister
